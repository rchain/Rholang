...
public class TType3 extends TType {
  ...
  public <R,A> R accept(parsing.lambda.Absyn.TType.Visitor<R,A> v, A arg) { return v.visit(this, arg); }

  public boolean equals(Object o) {
    if (this == o) return true;
    if (o instanceof parsing.lambda.Absyn.TType3) {
      parsing.lambda.Absyn.TType3 x = (parsing.lambda.Absyn.TType3)o;
