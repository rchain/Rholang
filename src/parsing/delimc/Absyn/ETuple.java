...
public class ETuple extends Expr {
  ...
  public ETuple(Expr p1, Expr p2, TType p3) { expr_1 = p1; expr_2 = p2; ttype_ = p3; }
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof parsing.delimc.Absyn.ETuple) {
      ...
      return this.expr_1.equals(x.expr_1) && this.expr_2.equals(x.expr_2) && this.ttype_.equals(x.ttype_);
    }
    return false;
  }

  public int hashCode() {
    return 37*(37*(this.expr_1.hashCode())+this.expr_2.hashCode())+this.ttype_.hashCode();
  }
